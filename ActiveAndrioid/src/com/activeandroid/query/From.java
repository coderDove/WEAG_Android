...
public final class From implements Sqlable {
	...
	final Table tableAnnotation = mType.getAnnotation(Table.class);

	if (!sql.toString().contains(tableAnnotation.id())
		&& !sql.toString().contains("*")) {
	    if (Debug.isDebuggerConnected()) {
		throw new RuntimeException(
			"you are forgetting include id in your query");
	    } else {
		Log.e("you are forgetting include id in your query");
	    }
	}
