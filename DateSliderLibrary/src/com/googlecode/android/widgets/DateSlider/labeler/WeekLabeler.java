...
public class WeekLabeler extends Labeler {
     ...
     */
    public TimeView createView(Context context, boolean isCenterView, int imgeSize) {
        return new CustomTimeTextView(context, isCenterView, 25, imgeSize);
    }
    ...
    private static class CustomTimeTextView extends TimeTextView {
        ...
        public CustomTimeTextView(Context context, boolean isCenterView, int textSize, int imgeSize) {
            super(context, isCenterView, textSize, imgeSize);
        }
