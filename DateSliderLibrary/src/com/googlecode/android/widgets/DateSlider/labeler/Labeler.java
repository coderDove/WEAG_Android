...
public abstract class Labeler {
     ...
     */
    public TimeView createView(Context context, boolean isCenterView, int textSize, int imageSize) {
        if (textSize < 0) {
            return new TimeTextView(context, isCenterView, TEXT_SIZE, imageSize);
        } else {
            return new TimeTextView(context, isCenterView, textSize, imageSize);
        }
    }
