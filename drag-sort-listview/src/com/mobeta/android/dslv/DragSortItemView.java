...
public class DragSortItemView extends ViewGroup {
	...
	final View undoChild = getChildAt(1);
	...
	undoChild.layout(0, 0, getMeasuredWidth(),
		undoChild.getMeasuredHeight());
    }
	...
	if (undoChild.isLayoutRequested()) {
	    // Always let child be as tall as it wants.
	    measureChild(undoChild, widthMeasureSpec,
		    MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
	}
	...
	if (heightMode == MeasureSpec.UNSPECIFIED) {
		...
		final int undoChildHeight = undoChild.getMeasuredHeight();
		if (childHeight > undoChildHeight) {
		    height = childHeight;
		} else {
		    height = undoChildHeight;
		}
	    }
	}
